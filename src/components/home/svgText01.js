        ...
        <>
            <svg className='svg-01' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 321.19 71">
                ...
                <g className='svg-group-bg-01'>
                    <path clipPath='url(#01)' d="M17.41,10c-4.42,0-8.15,2.63-10,6-2.64,4.82-1.54,11.33,3,15,4.22,3.41,10.68,3.76,15,0,4.59-3.99,4.52-10.66,2-15-.28-.48-3.6-6-10-6Z" />
                    <path clipPath='url(#01)' d="M44.41,2V44" />
                    <path clipPath='url(#01)' d="M45.41,21h14" />
                    <path clipPath='url(#01)' d="M14.41,41c-.33,8-.67,16-1,24" />
                    <path clipPath='url(#01)' d="M6.41,60c15.33-.33,30.67-.67,46-1" />
                    <path clipPath='url(#02)' d="M67.41,6V39" />
                    <path clipPath='url(#02)' d="M60.91,33.5c11.83,.17,23.67,.33,35.5,.5" />
                    <path clipPath='url(#02)' d="M90.41,12h13" />
                    <path clipPath='url(#02)' d="M89.41,23h14" />
                    <path clipPath='url(#02)' d="M108.41,0V41" />
                    <path clipPath='url(#02)' d="M92.41,46c-2.92-.25-2.27,.34-11,1-4.39,.33-5.07,.22-6,1-2.77,2.32-3.05,8.58,0,12,.06,.06,.18,.2,.36,.37,3.18,3.05,8.81,2.44,15.64,1.63,9.1-1.09,13.68-1.66,15-3,3.26-3.32,4.02-9.27,2-11-1.11-.95-2.34-.01-6,0-4.79,.02-4.99-1.58-10-2Z" />
                    <path clipPath='url(#03)' d="M138.41,1V7" />
                    <path clipPath='url(#03)' d="M121.41,13h35" />
                    <path clipPath='url(#03)' d="M137.64,20.89c-2.46,.1-4.2,.19-6.22,1.11-.9,.41-2.04,.93-3,2-1.94,2.17-1.78,5.11-1.55,8.41,.29,4.19,.52,7.49,2.94,9.21,1.23,.88,2.69,1.05,5.61,1.38,2.52,.29,4.35,.08,5,0,2.18-.28,3.64-.86,4-1,.73-.3,1.32-.53,2-1,.46-.32,2.57-1.76,3-4,.32-1.67-.62-2.06-1-5-.16-1.23,0-1.23,0-4,0-4.18-.02-6.28-1-7-.68-.5-1.15-.14-4,0-2.97,.14-2.89-.23-5.78-.11Z" />
                    <path clipPath='url(#03)' d="M164.41,2c.33,21,.67,42,1,63" />
                    <path clipPath='url(#03)' d="M157.41,28h22" />
                    <path clipPath='url(#04)' d="M199.41,6c.69,6.31,.41,11.44,0,15-.55,4.81-1.43,7.47-2,9-.11,.29-1.29,3.38-3,6-4.46,6.82-12.17,9.98-15,11" />
                    <path clipPath='url(#04)' d="M197.41,26c1.95,2.98,3.71,5.35,5,7,5.43,6.97,8.06,8.49,9,9,2.38,1.28,4.6,1.78,6,2" />
                    <path clipPath='url(#04)' d="M209.41,26h13" />
                    <path clipPath='url(#04)' d="M223.41,1c.33,22,.67,44,1,66" />
                    <path clipPath='url(#04)' d="M237.41,2V67" />
                    <path clipPath='url(#05)' d="M274.41,8c-8.01,.49-12.02,.74-14,3-2.79,3.18-2.81,9.34,0,12,1.36,1.29,2.49,.84,12,1,4.33,.07,8.67-.01,13,0,5.27,.02,6.55,.06,8-1,2.56-1.88,4.22-5.81,3-9-.82-2.13-2.63-3.2-4-4-.97-.57-3.07-1.63-10-2-4.22-.22-7.41-.04-8,0Z" />
                    <path clipPath='url(#05)' d="M268.91,31.5v18" />
                    <path clipPath='url(#05)' d="M284.91,31.5v18" />
                    <path clipPath='url(#05)' d="M248.41,54h57" />
                    <path clipPath='url(#06)' d="M315.41,50c-1.67,6-3.33,12-5,18" />
                </g>
